...
const mainClassNameGenerator = ({ attributes, blockProps }) => {
   let classes = `wp-block-timeline block-editor-block-list__block wp-block ${blockProps.className}`;
      ...
      return (
         <Fragment>
            ...
            <div {...blockProps} dataBlockId={blockId} className={classNames([mainClassName])}>
               <div className={classNames(["wp-block-timeline block-editor-block-list__layout"])}>
                  <svg xmlns="http://www.w3.org/2000/svg" class="circle" width="24" height="25" viewBox="0 0 24 25" fill="none">
                     <circle cx="12" cy="12.7246" r="11.5" stroke="black" />
                  </svg>
                  <svg class="line" width="1" height="80" viewBox="0 0 1 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <line x1="0.5" y1="0.724609" x2="0.499996" y2="79.725" stroke="black" />
                  </svg>
               </div>
            </div>
         </Fragment>
