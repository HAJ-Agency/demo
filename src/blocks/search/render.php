<div id="<?= $attributes['blockId']; ?>" class="<?= $attributes['mainClassName']; ?>">
   <button class="search-open-button" aria-label="<?= esc_attr__('Öppna sök', 'akka'); ?>">
   ...
   <div class="search-content-container">
      <div class="search-content-container-overlay">
         <button class="search-button" aria-label="<?= esc_attr__('Sök', 'akka'); ?>">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <input type="text" class="search-input" placeholder="<?= esc_attr__('Sök på produkt, ingrediens, behov eller något annat du vill hitta...', 'akka'); ?>" aria-label="<?= esc_attr__('Sök', 'akka'); ?>" />
         <button class="search-close-button" aria-label="<?= esc_attr__('Stäng sök', 'akka'); ?>">
   ...
   <div class="search-results-container">
      <div class="search-result-template">
         ...
         <div class="search-result-meta">
            ...
            <a class="search-result-link" href="#" target="_blank" rel="noopener noreferrer"><?= esc_html__('Läs mer', 'akka'); ?></a>
         </div>
      </div>
      <div class="search-results-container-overlay">
         ...
         <div class="search-results-show-more">
            <p class="search-results-empty"><?= __('Inga sidor hittades', 'akka') ?></p>
            <p class="search-results-number-of-pages"><?= esc_html__('Visar', 'akka') ?> <span class="search-results-showing"></span> <?= esc_html__('av', 'akka') ?> <span class="search-results-count"></span> <?= esc_html__('resultat', 'akka') ?></p>
